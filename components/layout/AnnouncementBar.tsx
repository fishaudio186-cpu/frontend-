...
export function AnnouncementBar() {
  return (
    <div className="bg-brand-forest-dark text-brand-gold-soft/90 text-center text-[10px] md:text-xs py-2 px-3 flex items-center justify-center gap-1.5 tracking-wide border-b border-brand-gold/20">
