...
export function HeroShowcase() {
  return (
    <div className="relative animate-soft-rise mx-auto w-full max-w-[420px] md:max-w-none">
      <div className="relative rounded-[1.5rem] md:rounded-[2rem] bg-white shadow-[0_32px_80px_rgba(53,10,25,0.38)] ring-1 ring-brand-gold/30 overflow-hidden">
        ...
        <div className="relative aspect-[4/2.8] md:aspect-[4/3.2] hero-plate">
          <Image
            ...
            className="object-contain p-3 md:p-8 drop-shadow-[0_28px_45px_rgba(53,10,25,0.16)]"
          />
        </div>
      </div>

      <div className="absolute -bottom-4 right-3 md:-bottom-5 md:right-6 flex items-center gap-2 rounded-xl md:rounded-2xl bg-brand-forest-dark/95 backdrop-blur px-3 md:px-4 py-2.5 md:py-3 shadow-[0_18px_40px_rgba(53,10,25,0.42)] border border-brand-gold/30">
